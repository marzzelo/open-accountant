...
def get_projections(
    ...
    expense_trend_mode: str = Query("linear", pattern=r"^(linear|inflation)$"),
    expense_trend_min: float | None = Query(None),
    expense_trend_max: float | None = Query(None),
    expense_inflation_base: float | None = Query(None),
    expense_inflation_rate: float | None = Query(None),
